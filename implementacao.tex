...
\setlength{\parindent}{2cm}
Para conclusão do trabalho o diagrama RTL é mostrado a seguir onde podemos observar  que existe os geradores de clock(A,B,C) juntamente com o sensor de velocidade formam o sistema de semáforos que serão cadenciados por estes blocos de acordo com a manipulação feita na placa FPGA. 
\vskip3ex
\begin{figure}
\centering
